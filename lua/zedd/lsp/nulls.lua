...
local on_attach = function(client, bufnr)
	...
	vim.cmd([[
	  highlight! DiagnosticLineNrError guibg=#FF0000 guifg=#FFF0000 gui=bold
	  highlight! DiagnosticLineNrWarn guibg=#FFA501 guifg=#FFF0000 gui=bold
	  highlight! DiagnosticLineNrInfo guibg=#00FFFF guifg=#FFF0000 gui=bold
	  highlight! DiagnosticLineNrHint guibg=#1563FF guifg=#FFF0000 gui=bold
